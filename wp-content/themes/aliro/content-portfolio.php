  ...
  <div class="ih-item">
      ...
      <div class="info">
	        <div class="info-inner">
	            ...
	            <a class="hidden zoom" href="<?php echo esc_url_raw( $image_attributes[0] ); ?>" rel="prettyPhoto[pp_gal]"> <i class="fa fa-search radius-x space-padding-10 btn-primary"></i> </a>
	        	<?php endif; ?>
	        </div>    
      </div>
  </div>
