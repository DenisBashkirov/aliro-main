...
<div class="<?php echo esc_attr( implode( ' ', $css_class ) ) ;?>"<?php echo esc_attr( $data_owl ); ?>>
	<?php if( count( $list_posts ) ): ?>
							...
							<div class="post-item-right">
								<div class="post_details">
									<h2 class="post-title-alt">
										<a href="<?php echo esc_url( get_permalink( $item->ID ) ); ?>" title="<?php echo get_the_title( $item ); ?>"><?php echo get_the_title( $item ); ?>
										</a>
									</h2>
								</div>
								<?php if ( $words > 0 ): ?>
								...
								<?php if ( $show_date == 'yes' ): ?>
									<div class="post-meta">
										<span class="post-author"><i class="fa fa-user"></i>  <a href="<?php echo get_author_posts_url( $item->post_author ); ?>" title="<?php esc_html_e( 'Posts by ', 'shu' ); echo get_the_author_meta( 'display_name', $item->post_author ); ?>" rel="author"><?php echo get_the_author_meta( 'display_name', $item->post_author ); ?></a></span>
										<span class="post-date">Time: <a href="<?php echo get_month_link( get_the_time( 'Y', $item->ID ), get_the_time( 'm', $item->ID ) ); ?>"><?php echo get_the_date( 'F m Y', $item->ID ); ?></a> </span>
										<?php if ( get_the_category( $item->ID ) ): ?>
											<span class="post-cats">Category: <?php the_category( ' ', '', $item->ID ); ?></span>
										<?php endif ?>
									</div>
								<?php endif ?>
								<a href="<?php echo esc_url( get_permalink( $item->ID ) ); ?>" class="post-2-button"><?php esc_html_e( 'Read more', 'shu' ); ?> <i class="fa fa-angle-right" aria-hidden="true"></i></a>
							</div>
		...
		?>
					...
					<div class="post-grid grid-<?php echo esc_attr( $number_item ); ?>">
						...
						<div class="kc-list-item-4">
							...
							<div class="post-footer">
								<ul class="social-share">
									...
									<li>
										<a href="http://www.facebook.com/sharer.php?u=<?php echo esc_url( get_permalink( $item->ID ) ); ?>" class="fa fa-facebook" target="_blank" title="<?php esc_html_e( 'Share on Facebook', 'shu' ); ?>"></a>
									</li>
									<li>
										<a href="http://twitter.com/home?status=<?php echo esc_url( get_permalink( $item->ID ) ); ?>" class="fa fa-twitter" target="_blank" title="<?php esc_html_e( 'Share on Twitter', 'shu' ); ?>"></a>
									</li>
									<li>
										<a href="http://plus.google.com/share?url=<?php echo esc_url( get_permalink( $item->ID ) ); ?>" class="fa fa-google-plus" target="_blank" title="<?php esc_html_e( 'Share on Google+', 'shu' ); ?>"></a>
									</li>
									<li>
										<a href="http://pinterest.com/pin/create/button/?url=<?php echo esc_url( get_permalink( $item->ID ) ); ?>&amp;media=<?php echo esc_url( $img_url ); ?>" class="fa fa-pinterest-p" target="_blank" title="<?php esc_html_e( 'Share on Pinterest', 'shu' ); ?>"></a>
									</li>
								</ul>
							</div>
						</div>
		...
		?>
					...
					<div class="item kc-list-item-1">
						...
						<div class="post-details">
							...
							<?php if ( $show_date == 'yes' ): ?>
								<div class="post-date">
									<span class="post-author"><?php esc_html_e( 'by', 'shu' ); ?> <a href="<?php echo get_author_posts_url( $item->post_author ); ?>" title="<?php esc_html_e( 'Posts by ', 'shu' ); echo get_the_author_meta( 'display_name', $item->post_author ); ?>" rel="author"><?php echo get_the_author_meta( 'display_name', $item->post_author ); ?></a></span>
	...
	<?php else: ?>
		...
		<h3><?php esc_html_e( 'Blog Post: Nothing not found.', 'shu' ); ?></h3>
