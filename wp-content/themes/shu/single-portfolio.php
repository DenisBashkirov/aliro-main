...
$shu_page_layouts = apply_filters( 'shu_fnc_get_single_portfolio_sidebar_configs', null );

get_header( apply_filters( 'shu_fnc_get_header_layout', null ) );

do_action( 'shu_template_main_before' ); ?>
<section id="main-container" class="<?php echo apply_filters( 'shu_template_main_content_class', 'container' ); ?> inner">
	<div class="row">
