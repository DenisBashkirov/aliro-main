...
$shu_page_layouts = apply_filters( 'shu_fnc_get_category_sidebar_configs', null ); 
$columns = shu_fnc_theme_options( 'blog-archive-column', 1 );
			...
			<div id="primary" class="content-area">
				<div id="content" class="site-content" role="main">
					...
					<header class="archive-header">
						<h1 class="archive-title"><?php printf( esc_html__( 'Category Archives: %s', 'shu' ), single_cat_title( '', false ) ); ?></h1>
