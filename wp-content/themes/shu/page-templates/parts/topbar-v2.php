<section id="opal-topbar" class="opal-topbar opal-topbar-v2">
    <div class="row">
...
-->        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 text-center">
 ...
 <span>с 9.00 до 18.00 без выходных&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
          ...
          <button class="btn-ilk eModal-3 hidden-xs"><i class="ilk" aria-hidden="true"></i>&nbsp;&nbsp;Личный&nbsp;кабинет<br><span class="spandiler">для дилеров</span></button>&nbsp; 
 </div>
